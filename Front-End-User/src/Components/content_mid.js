       ...
       <>
          {/* <div className="col-md-3 item-grid1 simpleCart_shelfItem">
                 ...
                 <div className="col-md-3 item-grid1 simpleCart_shelfItem">
                    ...
                    <Link to={`/${this.props.id}`}><img className="card-img-top img-responsive" src={domain+"/"+img.images[0]} alt="Card image cap"/></Link>
                    ...
                    <div className="mid-1">
                                    <div className="women">
                                            <div className="women-top">
                                                ...
                                                <h6 className='nameProduct'><Link to={`/${this.props.id}`}>{this.props.product.namProduct}</Link></h6>
