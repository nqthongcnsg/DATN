        ...
        <div className="col-md-4 item-grid1 simpleCart_shelfItem">
                            ...
                            <div className="pro-img">
                                ...
                                <div className="women-top">
                                    ...
                                    <h6 className="nameProduct"> <Link to={`/${this.props.id}`}>{this.props.name}</Link></h6>
                                    </div>
                                    ...
                                    <div className="mid-2">
                                        <div className="price-all">
                                            <label className="price-old">{this.props.priceOld}.000 vnđ</label>
                                            <em className="item_price priceAll">{this.props.priceNew}.000 vnđ</em>
                                        </div >
                                        <div className="block">
