...
function generateID(length){
	...
	<div class="container">
		<h1>Thanh toán</h1>
		<em></em>
		<h2><a href="/">Trang chủ</a><label>/</label>Thanh toán</h2>
	</div>
	</div>
			  ...
			  <div class="col-md-6 login-do">
                ...
                <li className="grupo1 "  id="id_tienda_url_mob_1"><input type="radio" name="rad" value="momo" className="radio1"/> <img src="/image/Ví-MOMO.jpg" class="logodiveinn_mobile momo" alt="diveinn" /></li>
				<li className="grupo1 "  id="id_tienda_url_mob_1"><input type="radio" name="rad" value="banking"/> <img src="/image/ngan-hang-dien-tu-la-gi.jpg" class="logodiveinn_mobile momo" alt="diveinn" /></li>
