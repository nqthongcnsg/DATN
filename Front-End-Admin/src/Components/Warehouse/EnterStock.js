            ...
            <div className="col-md-8 grid-margin stretch-card">
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title">Nhập kho</h4>
                  ...
                  <form className="forms-sample" onSubmit={handleSubmit}>
                    ...
                    <div className="btn btn-primary"onClick={onClick} >Nhập</div>
                    <button className="btn btn-light"><a href="/warehouse" >Quay lại</a></button>
                  </form>
                </div>
              </div>
            </div>
