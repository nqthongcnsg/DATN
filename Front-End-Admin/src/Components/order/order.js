            ...
            <div className="main-panel">
                <div className="content-wrapper px-0">
                    ...
                    active={flag}
                            ...
                            <div>
                            <input type="text" className="form-control text" id="search" placeholder="Mã đơn hàng" name="name"/>
                                <button class="hvr-skew-backward" onClick={onSearch}>Tìm kiếm</button>
                            </div>
                          <ContentAll
                          product={product}
                          >
